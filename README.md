...
A Capstone Project Completed As Part Of The 6-Month DEPI Data Analysis Program, Held Under The Digital Egypt Pioneers Initiative, In Collaboration With AMIT Learning. The Project Was Officially Presented And Discussed, Marking The End Of A Powerful Learning Journey — And The Start Of A Deeper Analytical Path.


Goal:

To Explore Real-World HR Challenges Through Data. The Objective Was To Support Better Decisions, Foster Fairer Workplaces, And Boost Employee Retention And Performance Through Clear, Data-Led Insights.


🛠️ Tools & Techniques Used:

✅ Python – For Data Cleaning, Preparation, And Exploration
✅ Power BI – For Building Interactive Dashboards And Visual Storytelling
✅ KPI Development – Focused On Metrics That Directly Impact HR Strategy
